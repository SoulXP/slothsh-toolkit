...
} // @END OF namespace slsh::functional::internal
...
constexpr auto swap(std::tuple<Ts...> ts)
{
    ...
    constexpr auto seq = slsh::utility::map_integer_sequence(mapping,
...
} // @END OF namspace slsh::functional
