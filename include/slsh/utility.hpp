...
#define DECLARE_ENUM_MAPPING(T1, T2, ...) slsh::utility::internal::enum_map<T1, T2>(__VA_ARGS__)
#define DECLARE_ENUM_MAPPING_BOOL(T1, T2, ...) slsh::utility::internal::enum_map<T1, T2>(__VA_ARGS__)
...
template<std::floating_point T, slsh::traits::StringLike S>
...
} // @END OF namespace slsh

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

namespace slsh::utility {

template<slsh::traits::StringLike T = std::string>
...
} // @END OF namespace slsh::utility

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

namespace slsh::utility::internal {

template<slsh::traits::StringLike T>
struct oversized_array
{
    std::array<slsh::traits::string_char_type_t<T>, VTM_BIGARRAY_SIZE> data{};
    std::size_t size;
};
...
template<typename Callable, slsh::traits::StringLike T>
consteval auto to_right_sized_array(Callable callable)
{
    ...
    std::array<slsh::traits::string_char_type_t<std::remove_cvref_t<T>>, oversized.size> result;
...
template<typename Callable, slsh::traits::StringLike TString, slsh::traits::StringViewLike TView>
...
template<slsh::traits::DefaultableEnum In,
         std::semiregular Out,
         slsh::traits::SameAsReturn<Out>... Mappings>
...
template<slsh::traits::DefaultableEnum In, typename Out, typename... OutArgs>
...
} // @END OF namespace slsh::utility::internal
...
template<std::invocable Callable,
         slsh::traits::StringLike TString = std::string,
         slsh::traits::StringViewLike TView = std::string_view>
consteval auto compile_time_string(Callable callable) -> std::remove_cvref_t<TView>
{
    static_assert(
        std::is_same_v<slsh::traits::string_char_type_t<TString>, slsh::traits::string_char_type_t<TView>>,
